...
<template>
  <div class="mc-page student-account">
    ...
    <div class="mc-card">
      <div class="mc-card__head">
        ...
        <span class="student-account__total">共 {{ total }} 条</span>
      </div>
      <div class="mc-card__body">
        <el-table v-loading="loading" :data="users" stripe max-height="600" style="width: 100%">
          ...
          <el-table-column label="学院 / 专业 / 班级" min-width="180" show-overflow-tooltip>
    ...
    <el-dialog v-model="detailDialogVisible" title="账号详情" width="560px" @close="detail = null">
      <el-descriptions v-if="detail" :column="2" border>
        <el-descriptions-item label="学号">{{ detail.userNo }}</el-descriptions-item>
