...
const list = ref<InternshipItem[]>([
  { id: '1', company: '科技有限公司', location: '社区服务中心', position: '部长', startDate: '2025-07-01', endDate: '2025-09-01', semester: '2023-2024-1', status: 'approved', submitDate: '2025-10-01', proofMaterials: [] },
])
  ...
  >
    <template #form>
      <el-form :model="form" label-width="120px">
        <el-form-item label="实习公司" required><el-input v-model="form.company" placeholder="请输入实习公司" /></el-form-item>
        <el-form-item label="实习地点" required><el-input v-model="form.location" placeholder="请输入实习地点" /></el-form-item>
        <el-form-item label="实习岗位" required><el-input v-model="form.position" placeholder="请输入实习岗位" /></el-form-item>
    ...
    <template #columns>
      ...
      <el-table-column label="状态" width="100">
        <template #default="{ row }"><StatusTag :status="(row as InternshipItem).status" size="small" /></template>
      </el-table-column>
    </template>
  </ApplicationFormRecord>
</template>
