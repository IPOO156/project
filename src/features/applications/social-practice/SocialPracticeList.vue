...
const list = ref<SocialPracticeItem[]>([
  { id: '1', activityName: '社区志愿服务', location: '社区服务中心', organization: '校志愿者协会', startDate: '2025-07-01', endDate: '2025-09-01', volunteerHours: 20, semester: '2023-2024-1', status: 'approved', submitDate: '2025-10-01', proofMaterials: [] },
])
  ...
  >
    <template #form>
      <el-form :model="form" label-width="120px">
        <el-form-item label="活动名称" required><el-input v-model="form.activityName" placeholder="请输入活动名称" /></el-form-item>
        <el-form-item label="活动地点" required><el-input v-model="form.location" placeholder="请输入活动地点" /></el-form-item>
        <el-form-item label="组织单位" required><el-input v-model="form.organization" placeholder="请输入组织单位" /></el-form-item>
        ...
        <el-form-item label="志愿时长">
          <el-input-number v-model="form.volunteerHours" :min="0" controls-position="right" class="form-input-number" />
        </el-form-item>
    ...
    <template #columns>
      ...
      <el-table-column label="状态" width="100">
        <template #default="{ row }"><StatusTag :status="(row as SocialPracticeItem).status" size="small" /></template>
      </el-table-column>
    </template>
  </ApplicationFormRecord>
</template>
